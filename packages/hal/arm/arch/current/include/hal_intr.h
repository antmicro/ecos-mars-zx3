...
#ifdef  CYGIMP_HAL_INTERRUPTS_THROTTLING_SUPPORT
externC void hal_interrupt_configure_throttling( int, unsigned int );
#endif
...
#ifdef  CYGIMP_HAL_INTERRUPTS_THROTTLING_SUPPORT
#define HAL_INTERRUPT_CONFIGURE_THROTTLING( _vector_, _delay_ ) \
    hal_interrupt_configure_throttling( _vector_, _delay_ )
#else
#define HAL_INTERRUPT_CONFIGURE_THROTTLING( _vector_, _delay_ )
#endif
